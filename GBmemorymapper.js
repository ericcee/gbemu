...
const BIOS_START = 0x00;
const CART_ROM_START = 0x100;
const CART_ROM_BANK0 = 0x50;
const CART_ROM_BANKU = 0x3F00;
const VIDEO_START = 0x8000;
const VIDEO_CHAR_RAM = 0x00;
const VIDEO_MAPDATA_1 = 0x1800;
const VIDEO_MAPDATA_2 = 0x1C00;
...
var wav_ram = new Uint8Array(16); // Start 0xFF30
var high_ram = new Uint8Array(0x7E); // Start 0xFF80
var work_ram = new Uint8Array(0x1FFF); // 0xC000
var video_ram = new Uint8Array(0x1FFF); // Start 0x8000
...
function readMem(address){
    ...
    if(address >= 0x8000 && address <= 0x97FF){ // Character RAM
        bytetoreturn = video_ram[address - 0x8000];
    }
    ...
    if(address >= 0xFE00 && address <= 0xFE9F){ // Object Attribute Memory (OAM)
        bytetoreturn = OAM[address - 0xFE00];
    }
